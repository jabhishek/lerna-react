...
exports.Button = (_a) => {
    ...
    return (core_1.jsx(src_1.Box, Object.assign({ as: "button", color: "red", cursor: "not-allowed", onClick: onClick, disabled: isDisabled, "aria-disabled": isDisabled, type: type }, styleProps, rest), children));
};
